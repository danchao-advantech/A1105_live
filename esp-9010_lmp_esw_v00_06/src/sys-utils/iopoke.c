...
void usage()
{
	printf("Write one byte to specific IO address.\n");
	printf("Usage\t: iopoke hex_addr hex_data\n");
	printf("Example\t: iopoke 0x500 0xff\n");
	return;
}
...
int main(int argc, char *argv[])
{
	...
	if (argc == 3 && strncmp(argv[1], "0x", 2) == 0 && strncmp(argv[2], "0x", 2) == 0) {
